...
class LlavaMetaForCausalLM(ABC):
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        if type(images) is list or images.ndim == 5:
            ...
            # print("split size of images[0]", images[0].shape[0])
            split_sizes = [image.shape[0] for image in images]
            image_features = torch.split(image_features, split_sizes, dim=0)
            # print("splited image features", image_features.shape)
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            # print("cur_input_embeds", cur_input_embeds.shape, "split_sizes", split_sizes)
        ...
        for i, (cur_new_embed, cur_new_labels) in enumerate(zip(new_input_embeds, new_labels)):
            # print("cur_new_embed", cur_new_embed.shape, "cur_new_labels", cur_new_labels.shape)
